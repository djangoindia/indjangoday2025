        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <h1 className="text-[#14342B] text-5xl sm:text-7xl md:text-8xl font-bold mb-6 relative z-10">
              ...
              <span className="text-[#14342B] text-xl sm:text-3xl font-bold bg-[#C1E0C9] p-[0.19rem] md:p-[0.55rem] ">India</span>
            </h1>
            ...
            <div className="flex flex-wrap w-full gap-6 mb-12">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-[#14342B] font-bold text-sm md:text-lg">Bangalore, India</span>
              </div>
            </div>

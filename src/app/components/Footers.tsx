...
const ContactSection: React.FC<{ primaryColor?: string }> = ({ primaryColor = '#ffffff' }) => {
  ...
  return (
    ...
    >
      ...
      <div 
        className="bottom-0 w-full border-t-[13px] border-[#514027] bg-[#ffd476] px-4 sm:px-8 md:px-12 lg:px-24 flex lg:flex-row items-center justify-end overflow-visible" 
        style={{ height: '40vh' }}
      >
        <div className="flex flex-row justify-between w-full h-full relative z-10">
          ...
          <div className="flex flex-col items-start justify-center h-full">
            <div className="w-full lg:w-auto">
              ...
              <Button
                size="lg"
                className="mt-2 sm:mt-4 text-sm sm:text-base px-4 sm:px-6 py-2 sm:py-3"
                onClick={() => {
              ...
              <div>
                ...
                <div className="pt-6 sm:pt-10">
                  <h3 className="text-base sm:text-xl text-gray-700 text-left">Connect Us on</h3>
                </div>
                ...
                <div className="flex gap-3 sm:gap-4 mt-2 sm:mt-0">
                  {socialLinks.map((link) => (
                    <a
                      ...
                      className="w-8 h-8 sm:w-10 sm:h-10 flex items-center justify-center rounded-full bg-[#205c4b] text-white hover:bg-[#2c5530] transition-colors"
        ...
        <div className="relative bottom-0 h-full flex items-end justify-end pointer-events-none select-none" style={{ zIndex: 0 }}>
          <Image
            ...
            className="w-[1200px] sm:w-[1200px] md:w-[1200px] lg:w-[1200px] h-auto" 
          />
        </div>
      </div>
